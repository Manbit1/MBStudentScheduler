# Manbit Student's scheduler. An open source scheduler app for student's and my first project on android
...
- There's a notes tab if you want to type some important stuff that you need to do like quiz times or deadlines
